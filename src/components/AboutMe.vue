...
<template>
  <div class="about-me">
    <h1 class="title-tag"><span>Über mich</span></h1>
    <div class="my-1"></div>
<!--    <p class="name-tag"><span>Samuel Vitel</span></p>
    <p class="address-tag"><span>Wien, Österreich</span></p>
    <p class="email-tag"><span class="email-after"></span></p>-->

    <img src="/src/assets/samuel_vitel.webp" alt="Samuel Vitel" style="opacity: 0.15">
